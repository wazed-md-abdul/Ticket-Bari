...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-white/70 dark:bg-slate-950/70 backdrop-blur-xl border-b border-slate-200/50 dark:border-slate-800/50 transition-all duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          {/* Navigation Links */}
          <div className="hidden md:flex items-center space-x-1 bg-slate-100/50 dark:bg-slate-900/40 p-1 rounded-2xl border border-slate-200/30 dark:border-slate-800/30">
            <Link 
              href="/" 
              className={`px-4 py-2 text-xs font-bold uppercase tracking-wider rounded-xl transition-all duration-300 ${
                pathname === "/" 
                  ? "bg-white dark:bg-slate-950 text-[var(--primary)] shadow-sm border border-slate-200/50 dark:border-slate-800/50" 
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <button
              onClick={toggleTheme}
              className="p-2.5 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200/50 dark:border-slate-800/50 hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-600 dark:text-slate-400 hover:scale-105 active:scale-95 transition-all"
            ...
            {isPending ? (
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="flex items-center space-x-2 bg-slate-50 dark:bg-slate-900 border border-slate-200/50 dark:border-slate-800/50 rounded-2xl p-1 pr-2.5">
                  <img
